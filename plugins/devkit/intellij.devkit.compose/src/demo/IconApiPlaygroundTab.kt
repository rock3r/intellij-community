...
internal fun IconApiPlaygroundTab(codeHighlighter: CodeHighlighter) {
  ...
  VerticallyScrollableContainer {
    Column(
      ...
      Text(
        "A throwaway tab for trying the new API from a Jewel tool window. Each preview renders the same icon in Jewel and Swing so the runtime behavior is easy to compare.",
